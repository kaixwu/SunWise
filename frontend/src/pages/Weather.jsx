...
export default function Weather() {
  ...
  if (locationError || !displayWeather || !displayForecast || displayForecast.length === 0) {
    return (
      <div style={{ maxWidth: "1600px", margin: "0 auto", padding: "88px 24px 24px", textAlign: "center" }}>
  ...
  return (
    ...
    <div style={{ maxWidth: "1600px", margin: "0 auto", padding: "88px 24px 24px", position: "relative" }}>
